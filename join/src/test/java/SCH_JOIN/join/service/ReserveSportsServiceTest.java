...
public class ReserveSportsServiceTest {

    @Autowired ReserveSportsService reserveSportsService;

    @Autowired ReserveSportsRepository repository;
    ...
    public void 로컬타임() throws Exception{
        ...
        List<ReserveSports> date = repository.findSoccerDate();
        for (ReserveSports reserves : date) {
            System.out.println("reserves = " + reserves.getMember().getName());
//            System.out.println("reserves = " + reserves.getStartDate());
//            System.out.println("reserves = " + reserves.getEndDate());
            System.out.println(" ===================== " );
        }
    ...
    @Test
    public void 구장생성() throws Exception{
        ...
        reserveSportsService.reserveSports(member.getId(), Sport.SOCCER, 12L, LocalDateTime.of(2000, 1, 3, 17, 30),

...
import farmconnect.farmconnectbackend.service.user.AuthUserService;
...
//        cal.add(Calendar.MINUTE, 498);
    ...
    public void updateRefreshToken(String originRefreshToken, String newRefreshToken) {
        ...
        fcmTokenRepository.updateRefreshToken(originRefreshToken, newRefreshToken);
        fcmTokenRepository.updateUpdateAt(newRefreshToken, refreshTokenRepository.findByRefreshToken(newRefreshToken).getCreatedAt());
    }
}